...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: lyMAaKzWLdHvk/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__wgBt, {
            [sty.box__long__wgBtNhQwl]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__c9Hl, {
              [sty.box__long__c9HlNhQwl]: hasVariant(variants, "long", "long")
            })}
          >
            <p.PlasmicSlot
              defaultContents={
                <svg
                  className={classNames(defaultcss.all, sty.svg__gb5R5)}
                  role={"img"}
                />
              }
      ...
      <div
        className={classNames(defaultcss.all, sty.box__rp49L, {
          [sty.box__long__rp49LNhQwl]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box___2CdDi, {
            [sty.box__long___2CdDiNhQwl]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__b1Wy)}
                role={"img"}
              />
            }
            value={args.iconBack}
