...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: lo_ewcOwPQqZLS/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: rUTXEpdqQsGgOC/icon
import profilepicW7Ni5KnUGle6Vs from "./images/profilepic.png"; // plasmic-import: w7ni5KnUGle6VS/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___7Ob1W)}
      >
        <div
