...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: dyip7JiyJQ8CGH/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__udYjy, {
          [sty.box__long__udYjyk9Kjy]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
          defaultContents={
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__i0Ho3, {
            [sty.box__long__i0Ho3K9Kjy]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__tL3Jo)}
                role={"img"}
              />
            }
            value={args.iconBack}
