...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: Y07cJb5HsPr_VF/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__zHn0K)}
      >
        <div className={classNames(defaultcss.all, sty.box__avwr7)}>
          <div className={classNames(defaultcss.all, sty.box__hQpxG)}>
            <p.PlasmicSlot
