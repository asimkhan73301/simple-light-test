...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: ZBva7mia3_PTQ/css

import heroImage45GFwmGoT3ErC from "./images/heroImage.png"; // plasmic-import: 45GFwmGoT3ER_c/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__zi3Nu)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__cdQsc)}
        >
          <div className={classNames(defaultcss.all, sty.box__yWw2M)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__baev1)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__iIy0N)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__s1Drg)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box___3RiCi)}>
          <img
