...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: 3rRJ2O6Jodr-H7/css
    ...
    >
      <p.PlasmicSlot
        defaultContents={
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__wkqFm)}
            role={"img"}
