...
import BaseCard from "../../BaseCard"; // plasmic-import: dyip7JiyJQ8CGH/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: gPi92wCYn77RcN/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__vumL5)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__ofNt)}
        >
          <p.PlasmicSlot
          ...
          <p.PlasmicSlot
            defaultContents={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__ypJvz)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__zmw6G)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__aKegb)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__k4Ino)}
                />
              </p.Stack>
            }
          ...
          <div className={classNames(defaultcss.all, sty.box___9FZjt)}>
            <p.PlasmicSlot
              defaultContents={
                <LinkButton
                  text={"Get started"}
